@extends('layouts.app', ['activePage' => 'register', 'title' => 'Register - Bottle Water Supply Chain Management'])

@section('content')
    <div class="full-page register-page section-image" data-color="orange" data-image="{{ asset('light-bootstrap/img/bg5.jpg') }}">
        <!-- Consistent overlay from welcome and login pages -->
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-md-8 text-center">
                        <div class="brand-header mb-4">
                            ...
                            <h2 class="text-white font-weight-bold mb-2" style="letter-spacing: -0.5px;">Join Our Network</h2>
                            <p class="text-white" style="opacity: 0.9;">Create your supply chain management account</p>
                        </div>
                    </div>
                </div>
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.2); border-right: none;">
                                                    <i class="nc-icon nc-single-02 text-white" style="opacity: 0.7;"></i>
                                                </span>
                                            </div>
                                            <input type="text" 
                                                   name="name" 
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.2); border-right: none;">
                                                    <i class="nc-icon nc-badge text-white" style="opacity: 0.7;"></i>
                                                </span>
                                            </div>
                                            <select name="role" 
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.2); border-right: none;">
                                                    <i class="nc-icon nc-check-2 text-white" style="opacity: 0.7;"></i>
                                                </span>
                                            </div>
                                            <input type="password" 
